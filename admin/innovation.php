...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Инновационные предложения</li>
  </ol>
</nav>
            ...
            <tbody>
               ...
               //создаём запрос к БД на вывод заявку из таблицы заявок на консультацию
                ...
                <tr>
                    ...
                    <td>
                      <a href="modules/innovation/accept.php?id=<?php echo $row["id"] ?>" class="btn mt-0 btn-sm btn-primary">Принять</a> 
                      <a href="modules/innovation/processed.php?id=<?php echo $row["id"] ?>" class="btn mt-0 btn-sm btn-primary">Обработано</a>
                      <a href="modules/innovation/reject.php?id=<?php echo $row["id"] ?>" class="btn mt-0 btn-sm btn-primary">Удалить</a>
                    </td>
                </tr>
              <?php     
              } 
