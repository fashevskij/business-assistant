...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Пользователи МБ</li>
  </ol>
</nav>
            ...
            <tbody>
               ...
               $sql = "SELECT * FROM users_b";
                ...
                <tr>
                    ...
                    <td>
                      <a href="modules/users_b/delete.php?id=<?php echo $row["id"] ?>" class="btn btn-primary">Удалить</a> 
                  </td>
                </tr>
              <?php     
              } 
