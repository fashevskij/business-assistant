...
<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">Заявки на товоры</li>
	</ol>
</nav>
				...
				<div class="table-responsive">
					<table class="table">
						...
						<tbody>
							...
							$sql = "SELECT * FROM request WHERE `status` = 'Новый'";
							...
							?>
								<tr>
									...
									<td>
										<a href="modules/request/detail.php?id=<?php echo $row["id"] ?>" class="btn btn-primary">Детальнее</a>
										<a href="modules/request/accept.php?id=<?php echo $row["id"] ?>" class="btn btn-primary">Принять</a>
										<a href="modules/request/reject.php?id=<?php echo $row["id"] ?>" class="btn btn-primary">Отклонить</a>
									</td>
								</tr>
							<?php
							}
